...
var server = require('http').createServer(ecstatic({ root: __dirname, handleError: false }));
var p2pserver = require('socket.io-p2p-server').Server; //set up p2p server
var io = require('socket.io')(server); //pass server and serveClient option (default true?)
